...
- example for the python command: '''python
processing.run('omm:match_trajectory', {'NETWORK': 'edge_data',
                                                                  'TRAJECTORY': 'omm_trajectory_test',
                                                                  'TRAJECTORY_ID': 'id',
                                                                  'CRS': '25833',
                                                                  'SIGMA': 50.0,
                                                                  'MY': 0.0,
                                                                  'MAX_SEARCH_DISTANCE': 120.0,
                                                                  'OUTPUT': '/Users/Christoph/Desktop/test.geojson'})
'''
